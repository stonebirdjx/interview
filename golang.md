...
- [go中哪些变量是不能比较的。](#go%E4%B8%AD%E5%93%AA%E4%BA%9B%E5%8F%98%E9%87%8F%E6%98%AF%E4%B8%8D%E8%83%BD%E6%AF%94%E8%BE%83%E7%9A%84)
- [go闭包的底层是什么？](#go%E9%97%AD%E5%8C%85%E7%9A%84%E5%BA%95%E5%B1%82%E6%98%AF%E4%BB%80%E4%B9%88)
- [空结构用过么？](#%E7%A9%BA%E7%BB%93%E6%9E%84%E7%94%A8%E8%BF%87%E4%B9%88)
- [全局G和本地G区别？](#%E5%85%A8%E5%B1%80g%E5%92%8C%E6%9C%AC%E5%9C%B0g%E5%8C%BA%E5%88%AB)
  - [Golang 标准库中 map 的底层数据结构是什么样子的？](#golang-%E6%A0%87%E5%87%86%E5%BA%93%E4%B8%AD-map-%E7%9A%84%E5%BA%95%E5%B1%82%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84%E6%98%AF%E4%BB%80%E4%B9%88%E6%A0%B7%E5%AD%90%E7%9A%84)
- [Map 使用时需要注意哪些问题?](#map-%E4%BD%BF%E7%94%A8%E6%97%B6%E9%9C%80%E8%A6%81%E6%B3%A8%E6%84%8F%E5%93%AA%E4%BA%9B%E9%97%AE%E9%A2%98)
- [Map 的 panic 能被 recover 吗?](#map-%E7%9A%84-panic-%E8%83%BD%E8%A2%AB-recover-%E5%90%97)
- [sync.Map 和加锁的区别是什么？](#syncmap-%E5%92%8C%E5%8A%A0%E9%94%81%E7%9A%84%E5%8C%BA%E5%88%AB%E6%98%AF%E4%BB%80%E4%B9%88)
- [Map 的查询时间复杂度如何分析？](#map-%E7%9A%84%E6%9F%A5%E8%AF%A2%E6%97%B6%E9%97%B4%E5%A4%8D%E6%9D%82%E5%BA%A6%E5%A6%82%E4%BD%95%E5%88%86%E6%9E%90)
- [Map Rehash 的策略是怎样的？什么时机会发生 Rehash？](#map-rehash-%E7%9A%84%E7%AD%96%E7%95%A5%E6%98%AF%E6%80%8E%E6%A0%B7%E7%9A%84%E4%BB%80%E4%B9%88%E6%97%B6%E6%9C%BA%E4%BC%9A%E5%8F%91%E7%94%9F-rehash)
- [Rehash 具体会影响什么？哈希结果会受到什么影响？](#rehash-%E5%85%B7%E4%BD%93%E4%BC%9A%E5%BD%B1%E5%93%8D%E4%BB%80%E4%B9%88%E5%93%88%E5%B8%8C%E7%BB%93%E6%9E%9C%E4%BC%9A%E5%8F%97%E5%88%B0%E4%BB%80%E4%B9%88%E5%BD%B1%E5%93%8D)
- [Rehash 过程中存放在旧桶的元素如何迁移？](#rehash-%E8%BF%87%E7%A8%8B%E4%B8%AD%E5%AD%98%E6%94%BE%E5%9C%A8%E6%97%A7%E6%A1%B6%E7%9A%84%E5%85%83%E7%B4%A0%E5%A6%82%E4%BD%95%E8%BF%81%E7%A7%BB)
- [未被初始化的 channel 进行读写会有什么问题？](#%E6%9C%AA%E8%A2%AB%E5%88%9D%E5%A7%8B%E5%8C%96%E7%9A%84-channel-%E8%BF%9B%E8%A1%8C%E8%AF%BB%E5%86%99%E4%BC%9A%E6%9C%89%E4%BB%80%E4%B9%88%E9%97%AE%E9%A2%98)
- [对未初始化的channel关闭](#%E5%AF%B9%E6%9C%AA%E5%88%9D%E5%A7%8B%E5%8C%96%E7%9A%84channel%E5%85%B3%E9%97%AD)
...
引用类型不能直接比较，结构体干不能比较的成员，该结构体也不能比较

# go闭包的底层是什么？

函数闭包一点也不神秘，它就是函数和引用环境而组合的实体。在Go中，闭包在底层是一个结构体对象，它包含了函数指针与自由变量。

Go编译器的逃逸分析机制，会将闭包对象分配至堆中，这样自由变量就不会随着函数栈的销毁而消失，它能依附着闭包实体而一直存在。

# 空结构用过么？ 

不占用内存空间，具有很强语义性，通常作为占位符 通知子协程任务执行

# 全局G和本地G区别？ 

全局G:存放等待运行的G 本地G：存放等待运行的G，数量有限制，新建G优先添加本地，如果队列满了，则会把本地一半G移动到全局G队列 
...
- sync.Map 使用了更高级的算法来避免竞争条件和数据竞争问题，而不需要显式地进行加锁和解锁。当多个 goroutine 同时访问 sync.Map 时，它会自动分配不同的段来存储数据，并且每个段都有自己的读写锁，以避免竞争条件。
...
所以对于未初始化的通道进行读写操作时都会报错 nil chan 。

# 对未初始化的channel关闭

可以看到会有 panic  发生，所以在使用 时一定要确保对其已经初始化操作。
